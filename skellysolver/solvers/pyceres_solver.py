...
class PyceresOptimizer(ABaseModel):
    ...
    parameter_blocks: dict[str, np.ndarray] = {}

    @property
    def loss_function(self) -> pyceres.LossFunction:
        return self.config.get_loss_function()
...
class BatchOptimizer:
    ...
    def __init__(
        ...
        *,
        ...
        self.optimizers = [
            PyceresOptimizer(config=config)
            for _ in range(num_problems)
        ]
    
    def get_optimizer(self, *, problem_idx: int) -> PyceresOptimizer:
