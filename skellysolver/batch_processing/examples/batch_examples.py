...
from ...batch_processing.report import BatchReportGenerator
from ...batch_processing.utils import (
...
def example_2_parameter_sweep() -> None:
    ...
    from ...batch_processing.report import find_best_parameters
...
def example_4_manual_batch_creation() -> None:
    ...
    config1 = RigidBodyConfig(
        ...
        topology=topology,
        optimization=OptimizationConfig(max_iterations=300),
        weights=MocapWeightConfig(lambda_rigid=1000.0),
    )
    ...
    config2 = RigidBodyConfig(
        ...
        topology=topology,
        optimization=OptimizationConfig(max_iterations=300),
        weights=MocapWeightConfig(lambda_rigid=500.0),
    )
    ...
    config3 = RigidBodyConfig(
        ...
        topology=topology,
        optimization=OptimizationConfig(max_iterations=300),
        weights=MocapWeightConfig(lambda_rigid=100.0),
    )
...
def example_5_analyze_sweep_results() -> None:
    ...
    # Analyze results
    from ...batch_processing.report import (
